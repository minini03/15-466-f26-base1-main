...
copies.push( maek.COPY(`assets/box.png`, `dist/box.png`) );
copies.push( maek.COPY(`assets/player1.png`, `dist/player1.png`) );
copies.push( maek.COPY(`assets/player2.png`, `dist/player2.png`) );
copies.push( maek.COPY(`assets/exit1.png`, `dist/exit1.png`) );
copies.push( maek.COPY(`assets/door1.png`, `dist/door1.png`) );
copies.push( maek.COPY(`assets/door2.png`, `dist/door2.png`) );
copies.push( maek.COPY(`assets/coin.png`, `dist/coin.png`) );
copies.push( maek.COPY(`assets/you.png`, `dist/you.png`) );
copies.push( maek.COPY(`assets/win.png`, `dist/win.png`) );
copies.push( maek.COPY(`assets/die.png`, `dist/die.png`) );
...
const extract_assets_obj = maek.CPP('extract_assets.cpp');
